...
🌱 Actively building projects in both cybersecurity and analytics to showcase practical skills.


## Objective
To launch my career as a **Security Analyst (Tier 1 SOC)** by applying hands-on skills in log analysis, security monitoring, and incident response.  
I also bring strong **business analytics  and quality analysis experience** in data cleaning, visualization, and deriving insights that support strategic decision-making. 

## 🛠️ Skills and Associated Projects
| Skill | Associated Project |
|-------|---------------------|
| SIEM Log Analysis & Threat Detection | [Security Log Analysis Project](https://github.com/CHANGEME/cybersecurity-log-analysis) |
| Vulnerability Assessment (M365) | [Secure Score Capstone](https://github.com/CHANGEME/cybersecurity-secure-score) |
| Incident Response Documentation | [Incident Playbook Demo](https://github.com/CHANGEME/cybersecurity-playbook) |
| Data Cleaning & Visualization | [Sales Dashboard Project](https://github.com/CHANGEME/businessanalytics-sales-dashboard) |
| Research & System Evaluation | [Sofvie Analytics Capstone](https://github.com/CHANGEME/businessanalytics-sofvie) |
...
- SIEM basics (Splunk/ELK simulation)  
- Incident Response & Phishing Detection  
- Threat Modeling  
